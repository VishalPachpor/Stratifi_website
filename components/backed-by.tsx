    ...
    <section className="relative w-full overflow-hidden bg-white font-light text-black antialiased py-16 scroll-smooth scroll-optimized no-scroll-jank">
      <div className="relative z-10 max-w-6xl mx-auto px-4 md:px-6 lg:px-8">
        ...
        <motion.div
          ...
          className="grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-8 lg:gap-12 place-items-center"
        >
          {backers.map((backer, index) => (
            ...
            >
              <div className="w-16 h-16 md:w-20 md:h-20 lg:w-24 lg:h-24 flex-shrink-0 bg-white rounded-lg p-2 md:p-3 flex items-center justify-center">
                <Image
                  src={backer.logoSrc}
