 ...
 * Provides smooth navigation with mobile menu and animations
 */
export default function Navigation() {
  ...
  return (
    <>
      {/* Desktop Navigation */}
      <nav className="absolute md:fixed top-0 left-0 right-0 z-30 flex items-center justify-between px-4 sm:px-8 py-3 sm:py-3 bg-transparent">
        ...
        <div className="hidden md:flex items-center space-x-8">
          <Link
            ...
            className="text-black hover:text-[#c479fe] hover:underline transition-colors font-light"
          >
            Docs
          </Link>
          <Button
        ...
        {isMobileMenuOpen && (
          <div className="absolute inset-0 z-50 md:hidden">
            ...
            <motion.div
              ...
              animate="open"
              exit="closed"
              className="absolute top-0 right-0 h-full w-72 sm:w-80 bg-white border-l border-black/10 shadow-2xl android-mobile-menu"
            >
