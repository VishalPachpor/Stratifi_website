        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-10 md:gap-12 items-start">
          <div className="md:col-span-2">
            <motion.h2
              ...
              className="text-3xl sm:text-4xl md:text-5xl font-light mb-6 text-black whitespace-nowrap"
            >
              Still have question..
            </motion.h2>
            <motion.p
              ...
              className="text-black/80 text-lg leading-relaxed mb-8"
            >
            ...
            >
              <Link
                ...
                target="_blank"
                className="inline-flex items-center rounded-full border-2 border-[#c479fe] px-6 py-3 text-base font-medium text-black hover:bg-[#c479fe]/10 hover:scale-105 transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#c479fe] focus-visible:ring-offset-2 focus-visible:ring-offset-white"
              >
                Docs
              </Link>
            </motion.div>
            ...
            >
              ...
              >
                <AccordionItem value="q1" className="px-4">
                  ...
                  <AccordionContent>
                    <p className="text-black/80 text-sm md:text-base leading-relaxed">
                      ...
                      optimization. Instead of parking funds in a single
                      account, it actively scans multiple money market protocols
                      like Morpho, Compound, Moonwell, and Seamless to find the
                      best yield based on your risk preferences. You can choose
                      to let the agent run fully autonomously or just get
                      research suggestions before making decisions. Your funds
                      remain in your non-custodial smart account, with no
                      lock-ups and the ability to withdraw anytime.
                    </p>
                  </AccordionContent>
                </AccordionItem>
                ...
                <AccordionItem value="q2" className="px-4">
                  <AccordionTrigger className="text-left text-xl md:text-2xl font-medium text-black py-6">
                    Can I use StratiFi AI Agent if I’m new to crypto or don’t
                    have a wallet?
                  </AccordionTrigger>
                  <AccordionContent>
                    <p className="text-black/80 text-sm md:text-base leading-relaxed">
                      Yes. StratiFi is designed for both beginners and advanced
                      DeFi users. If you don’t already have a wallet, we guide
                      you through secure wallet creation so you can get started
                      quickly.
                    </p>
                  </AccordionContent>
                </AccordionItem>
                ...
                <AccordionItem value="q3" className="px-4">
                  ...
                  <AccordionContent>
                    <p className="text-black/80 text-sm md:text-base leading-relaxed">
                      The AI Agent allocates your assets into vetted DeFi
                      lending protocols where borrowers must
                      overcollateralize—reducing default risk. It constantly
                      monitors rates, liquidity, and market conditions, and
                      rotates funds to higher-yield pools when beneficial. All
                      strategies are executed through secure, pre-approved smart
                      contracts.
                    </p>
                  </AccordionContent>
                </AccordionItem>
                ...
                <AccordionItem value="q4" className="px-4">
                  ...
                  <AccordionContent>
                    <p className="text-black/80 text-sm md:text-base leading-relaxed">
                      ...
                      you. On top of that, some protocols offer short-term
                      rewards to attract liquidity, which StratiFi can capture
                      for you while keeping positions balanced and secure.
                    </p>
                  </AccordionContent>
                </AccordionItem>
                ...
                <AccordionItem value="q5" className="px-4">
                  ...
                  <AccordionContent>
                    <ul className="list-disc pl-5 space-y-2 text-black/80 text-sm md:text-base leading-relaxed">
                      ...
                      <li>
                        Operates fully non-custodially — you keep full control
                        of your assets
                      </li>
                      <li>
                      ...
                      <li>
                        Supports primarily stablecoins and major assets to
                ...
                <AccordionItem value="q8" className="px-4">
                  ...
                  <AccordionContent>
                    ...
                    <ul className="list-disc pl-5 space-y-2 text-black/80 text-sm md:text-base leading-relaxed">
                      <li>
                        <strong>Full Autonomy:</strong> AI executes strategies
                        for you after one approval.
                      </li>
                      <li>
